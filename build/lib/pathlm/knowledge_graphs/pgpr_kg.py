...
from pathlm.knowledge_graphs.kg_utils import get_entities, get_dataset_relations, MAIN_PRODUCT_INTERACTION, USER, \
    get_knowledge_derived_relations, get_entity_tail
from pathlm.knowledge_graphs.kg_base import KnowledgeGraph
